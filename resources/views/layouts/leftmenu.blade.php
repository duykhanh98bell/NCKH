    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="text-muted text-xs block">Lập trình website <b class="caret"></b></span>
                    </a>
           ...
           <!--  <li>
            ...
            <li>
                <a href="#"><i class="fa fa-globe"></i> <span class="nav-label">Timeline</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="{{route('get-timeline')}}">Timeline du an</a></li>
                    <li><a href="{{route('get-time')}}">Timeline theo nhan vien</a></li>
                </ul>
            </li>
